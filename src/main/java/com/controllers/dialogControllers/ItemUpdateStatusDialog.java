...
public class ItemUpdateStatusDialog extends Dialog<Tuple<PurchaseRequestStatus, String>> {
    ...
    public ItemUpdateStatusDialog() {
        super();
        this.setTitle("Item Status");
        this.setDialogPane(loadFXML());
    }

    private DialogPane loadFXML() {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource(DialogPath.ITEM_UPDATE_STATUS_DIALOG.getPath()));
